 ...
 * <a href="http://gavwood.com/paper.pdf"> yellow paper</a> and
 * <a href="https://github.com/ethereum/wiki/wiki/RLP">here</a>.
 * </p>
 */
public class RlpEncoder {
	...
	public static byte[] encode(RlpType value) {
		...
		} else if (value instanceof RlpUint32) {
			return ((RlpUint32) value).encode();
		}
